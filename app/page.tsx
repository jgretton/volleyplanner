  ...
  '@graph': [
    {
      ...
      offers: [
        ...
        },
        {
          ...
          price: '6',
          priceCurrency: 'GBP',
          description: 'Unlimited session plans, saved history, regenerate drills, PDF export',
...
export default function HomePage() {
  return (
    <div className="bg-vp-bg">
      ...
      {/* ── Hero ─────────────────────────────────────────────────────────── */}
      <section id="plan-form" className="relative overflow-hidden border-b border-vp-border">
        <CourtLines />
        ...
        <div className="relative max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-48">
          ...
          <div className="text-center mb-20 animate-fade-up">
            ...
            <p className="text-vp-muted text-base leading-relaxed max-w-2xl mx-auto">
              ...
              VolleyPlanner puts together a full session plan with drills, diagrams, coaching points,
              and timings in under a minute.
            </p>
          </div>
      ...
      <section id="showcase" className="border-b border-vp-border">
        <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-10 lg:gap-20 items-start mb-12">
            <div>
              <p className="text-xs font-medium uppercase tracking-widest text-orange mb-4">Real output</p>
              <h2 className="font-display font-bold uppercase tracking-tight text-vp-text leading-[0.95] text-[clamp(2.5rem,5vw,3.5rem)]">
                This is what<br />you get
              </h2>
            </div>
        ...
        <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              <p className="text-xs font-medium uppercase tracking-widest text-orange mb-4">Session view</p>
              <h2 className="font-display font-bold uppercase tracking-tight text-vp-text leading-[0.95] text-[clamp(2.5rem,5vw,3.5rem)] mb-6">
                Built for the<br />sports hall,<br />not a desk
              </h2>
              <p className="text-vp-muted text-base leading-relaxed mb-6">
                The session view is designed for your phone at the side of the court.
                Tap any drill to see the full instructions and court diagram.
                No zooming, no scrolling through pages of text mid-warm-up.
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-sm text-vp-muted">
                    <Check size={13} className="text-orange/70 shrink-0 mt-0.5" />
                    {item}
                  </li>
                ))}
              </ul>
